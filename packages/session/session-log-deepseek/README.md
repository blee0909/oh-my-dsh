...
| `maxBatchBytes` | `4194304` | Maximum serialized JSON UTF-8 byte size of contributed session log events per request. Suffixes exceeding the cap drain across successive requests. |
