...
export class LlmRuntime extends TypertRemoteService {
  ...
  private async * adapterStream(
    ...
    try {
      ...
      const outboundMessages = transformMessages(projectedOptions.messages as Message[], {
      ...
      const wireOptions = outboundMessages === projectedOptions.messages
        ...
        : Object.isFrozen(projectedOptions)
          ? deepFreeze({ ...projectedOptions, messages: outboundMessages as RequestMessage[] })
          : { ...projectedOptions, messages: outboundMessages as RequestMessage[] }
